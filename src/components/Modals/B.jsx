...
const B = ({show, setShow, setModalItem}) => {
    ...
    const getUsContacts = async() => {
        await axios.get(`https://contact.mediusware.com/api/country-contacts/United%20States/?search=${query}&page=1&page_size=${curContactsCount}`).then(res => setData(res.data.results))
    }
    useEffect(() => {
        getUsContacts();
